...
Public Class EntrevistaForma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProdeskNet.EntrevistaForma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEntrevistaForma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EntrevistaForma = New EntrevistaForma()
        rpt.Site = Me.Site
        Return rpt
    End Function
