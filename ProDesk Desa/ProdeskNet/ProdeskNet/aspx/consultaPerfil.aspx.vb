...
Public Class consultaPerfil
    ...
    Private Sub BuscaDatos()
        Try
            ...
            If objPer.BuscaPermiso(Session("IdUsua")) Then
                dtsRes = clsPerfil.ObtenTodos()
            Else
                dtsRes = clsPerfil.ObtenPerfiles(1)
            End If
    ...
    Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Response.Redirect("./altaPerfil.aspx", False)
    End Sub
    ...
    Protected Sub grvConsulta_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grvConsulta.RowCommand
        ...
        If e.CommandName = "catPerfilId" Then
            Session("Nivel") += 1
            Dim path As String = "./manejaPerfil.aspx?idPerfil=" & e.CommandArgument
