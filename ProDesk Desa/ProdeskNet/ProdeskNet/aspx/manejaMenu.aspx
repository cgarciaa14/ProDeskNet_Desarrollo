<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/aspx/Home.Master" CodeFile="manejaMenu.aspx.vb" Inherits="manejaMenu" %>
            ...
            <div style="position:absolute; top:0%; left:0%; width:40%;">
                <table>
                    ...
                    <tr id="trLink" runat="server">
                        <td ><label style="font-size: 8pt;font-family: Arial;color: #666666;">* Link:</label></td>
                        <td>
                            <asp:TextBox runat="server" SkinID="txtCustMinGde"  id="txtLink"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="trAcc" runat="server">
                        <td ><label style="font-size: 8pt;font-family: Arial;color: #666666;">* Acceso Directo:</label></td>
                        <td>
