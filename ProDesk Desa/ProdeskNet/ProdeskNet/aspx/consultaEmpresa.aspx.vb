...
Public Class consultaEmpresa
    ...
    Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Response.Redirect("./manejaEmpresa.aspx", False) 'AVH
    End Sub
    ...
    Protected Sub grvConsulta_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grvConsulta.RowCommand
        ...
        If e.CommandName = "catEmpId" Then
            Session("Nivel") += 1
            Dim path As String = "./manejaEmpresa.aspx?idEmp=" & e.CommandArgument
