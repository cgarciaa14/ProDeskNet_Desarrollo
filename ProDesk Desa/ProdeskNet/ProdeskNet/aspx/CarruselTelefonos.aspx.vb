...
Partial Class aspx_CarruselTelefonos
    Inherits System.Web.UI.Page

    Dim BD As New clsManejaBD
    Dim DB As ProdeskNet.BD.clsManejaBD = New ProdeskNet.BD.clsManejaBD()

    Private Sub aspx_CarruselTelefonos_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub btnprocesar_Click(sender As Object, e As EventArgs) Handles btnprocesar.Click
        ...
        Dim hitCarrusel As Boolean = CarruselTEL(Request("Sol").ToString())
    ...
    Private Function CarruselTEL(ByVal folio As String) As String
