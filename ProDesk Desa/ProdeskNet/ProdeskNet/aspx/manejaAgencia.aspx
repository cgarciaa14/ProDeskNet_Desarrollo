<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/aspx/Home.Master" CodeFile="manejaAgencia.aspx.vb" Inherits="aspx_manejaAgencia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphPantallas" runat="server">
    <div class="divAdminCat">
        <div class="divFiltrosConsul">
            <table>
                <tr>
                    <td class="tituloConsul">Agencia</td>
                </tr>
            </table>
        </div>
        <div class="divAdminCatCuerpo">
            <div style="position:absolute; top:0%; left:0%; width:40%;">
                <table>
                    ...
                    <tr>
                        <td ><label style="font-size: 8pt;font-family: Arial;color: #666666;">* Nombre Agencia:</label></td>
                    ...
                    <tr>
                        <td ><label style="font-size: 8pt;font-family: Arial;color: #666666;">* Distribuidor:</label></td>
                        <td><asp:DropDownList ID="ddlDistribuidor" runat="server" CssClass="selectBBVA"></asp:DropDownList></td>
                    </tr>
<%--                    <tr>
