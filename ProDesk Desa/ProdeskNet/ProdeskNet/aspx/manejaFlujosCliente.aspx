<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Home.master" AutoEventWireup="false" CodeFile="manejaFlujosCliente.aspx.vb" Inherits="aspx_manejaFlujosCliente" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ MasterType VirtualPath="~/aspx/home.master" %> 

<%--BBVA-PD-BUG-PD-112: 28/06/2017: CGARCIA: SE REPLICO LA PANTALLA DE MANEJ FLUJOS CON ALGUNOS CAMBIOS PARTICULARES--%>
<%----BBVA: BUG-PD-194: 22/08/2017: CGARCIA: SE QUITARON CONTROLES QUE NO REQUIEEREN CLIENTES--%>
    ...
    <div class="divAdminCat">
        ...
        <div class="divAdminCatCuerpo">
            <div style="position:absolute; top:0%; left:0%; width:100%; border-style:ridge; border-color:#808080; border-width:2px;">
                <table>
                    ...
                    <tr>
                        ...
                        <td visible="false" id="tdOrden" runat="server"><label class="labelStyle">* Orden:</label></td> 
                        <td><asp:TextBox runat="server" SkinID="txtNumerosGde"  id="txtOrden" Visible="false"></asp:TextBox> </td>             
                        <td></td>
            ...
            <div>
                ...
                <asp:Panel id="popAltaProcesos" runat="server" style="display: none; border: 1px solid #ffffff; padding-top:20px;"
                BackColor="#F2F2F2" 
                width="35%" 
                Height="25%">
                    <table width="100%">
                        <tr>
                            <td class="tituloConsul">Procesos:</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td id="tdOrden1" runat="server" visible="false"><label class="labelStyle">* Orden:</label></td> 
                            <td><asp:TextBox runat="server" SkinID="txtNumerosGde" id="txtOrdenProc" Visible="false"></asp:TextBox> </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="tdParallelPro" runat="server" visible="false">
            ...
            <cc1:ModalPopupExtender ID="mpeAltaTareas" 
                ...
                BackgroundCssClass="modalBackground"/>  
            <asp:Panel id="popAltaTareas" runat="server" style="display: none; border: 1px solid #ffffff; padding-top:20px;"
                BackColor="#F2F2F2" 
                width="35%" 
                Height="33%">
                <table width="100%">
                   ...
                   <tr id="ordenTarea" runat="server" visible="false">
                     <td  id="tdOrden22" runat="server" visible="false"><label class="labelStyle">* Orden:</label></td> 
                     <td><asp:TextBox runat="server" SkinID="txtNumerosGde" id="txtTareaOrden" Visible="false"></asp:TextBox> </td>
                   </tr>
                   <tr id="tarpadretar" runat="server" visible="false">
                   ...
                   <tr id="parallelTar" runat="server" visible="false">
                     <td ><label class="labelStyle">* Parallel:</label></td> 
                    ...
                    <Panes>
                        <cc1:AccordionPane ID="AccPnlAct" runat="server"  >
                            ...
                            <Content>
                               <table width="100%">
                                    <tr>
                                        <td><asp:Button ID="btnAltaProcesos" runat="server" Text="Alta Procesos" CssClass="buttonBBVA2"  Visible="false"/></td>
                                    </tr>
                                    <tr>
                                        <td>
                    ...
                    <Panes>
                        <cc1:AccordionPane ID="AccordionPane1" runat="server">
                            ...
                            <Content>
                               <table width="100%">
                                    <tr>
                                        <td><asp:Button ID="btnAltaTareas" runat="server" Text="Alta Tareas" CssClass="buttonBBVA2" Visible="false"/></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="grdTareas" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Pant." ItemStyle-Width="5%" ItemStyle-HorizontalAlign="center" Visible="false">
                                                        <ItemTemplate>
            ...
            <table width="100%" style="height:100%;">
                <tr>
                    <td align="center" valign="middle">
                        ...
                        <asp:Button runat="server" ID="bthRegresar" Text="Regresar" CssClass="buttonSecBBVA2"/>
