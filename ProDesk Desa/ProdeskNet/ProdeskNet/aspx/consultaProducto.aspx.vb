'BBV-P-423: RQSOL-03: AVH: 10/11/2016 SE CAMBIA LA DIRECCION AL AGREGAR
...
Public Class consultaProducto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Session("idpresa") = Request("Idemp")

            'If Session("idpresa") <> Nothing Then
            '    LlenarEmpresa()
            '    cmbEmpresa.SelectedIndex = cmbEmpresa.Items.IndexOf(cmbEmpresa.Items.FindByValue(Session("idpresa")))
            '    BuscaDatos()
            'Else
    ...
    Private Sub BuscaDatos()
        Try
            ...
            dtsRes = clsProductos.ObtenerProductoEmp(cmbEmpresa.SelectedValue)
    ...
    Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Response.Redirect("./manejaProducto.aspx", False) 'AVH
    End Sub
    Protected Sub grvConsulta_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grvConsulta.RowCommand
        ...
        If e.CommandName = "catIdProd" Then
            Session("Nivel") += 1
            Dim path As String = "./manejaProducto.aspx?idProd=" & e.CommandArgument
    ...
    Private Sub cmbEmpresa_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles cmbEmpresa.SelectedIndexChanged
        BuscaDatos()
    End Sub
End Class