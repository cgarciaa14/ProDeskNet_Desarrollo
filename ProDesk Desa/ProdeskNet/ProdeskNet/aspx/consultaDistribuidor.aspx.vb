...
Public Class consultaDistribuidora
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        BuscaDatos()
        Master.EjecutaJS("$('#search').keyup(function () {searchTable($(this).val(), $('[id$=grvConsulta]'));});")
    ...
    Public Sub llenaPlaza()
        Try
            ...
            If ddlempresa.SelectedValue > 0 Then
                objEmpresa.PDK_ID_EMPRESA = ddlempresa.SelectedValue
                objEmpresa.getPlaza()
    ...
    Private Sub BuscaDatos()
        Try
            ...
            Dim objDist As New clsDistribuidor

            objDist.PDK_ID_PLAZA = ddlPlaza.SelectedValue
            objDist.PDK_ID_EMPRESA = ddlempresa.SelectedValue

            objDist.ObtenDistribuidores()

            dtsRes = objDist.DistribuidoresDS
    ...
    Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Response.Redirect("./altaDistribuidor.aspx", False)
    End Sub
    ...
    Protected Sub grvConsulta_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grvConsulta.RowCommand
        ...
        If e.CommandName = "catDisId" Then
            Session("Nivel") += 1
            Dim path As String = "./manejaDistribuidor.aspx?idDist=" & e.CommandArgument
