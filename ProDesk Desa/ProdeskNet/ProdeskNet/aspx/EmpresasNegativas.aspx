<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Home.master" AutoEventWireup="false" CodeFile="EmpresasNegativas.aspx.vb" Inherits="aspx_EmpresasNegativas" %>
        ...
        <div class ="divFiltrosConsul" style="padding-right:5px;" >
            <table class="tabFiltrosConsul">
                ...
                <tr class="tituloConsul">
                    <td colspan="2" style="width:70%;">Precalificación 2</td>
                    <%--<td colspan="2" style="width:70%;">Empresas Negativas</td>--%>
