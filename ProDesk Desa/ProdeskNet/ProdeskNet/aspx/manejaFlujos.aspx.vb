' BUG-PD-346 :DCORNEJO: 23/01/2018: Se realizo la correcion al ordenar de manera alfabetica la carga de los combos al dar de alta o modificar Tarea

Imports ProdeskNet.Catalogos
Imports ProdeskNet.Configurcion
Imports System.Data

Public Class manejaFlujos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If Val(Request("idFlujo")) > 0 Then
                ...
                LlenaCombo(1) 'LLENA EL COMBO DE EMPRESA
                LlenaCombo(2) 'lLENA EL COMBO DE PRODUCTO PARA ALTA DE TAREAS
                ObtenFlujo()
                ObtenProceso()
    ...
    Private Sub LlenaCombo(ByVal intCombo As Integer)
        ...
        Try
            ...
            If intCombo = 5 Then ' Combo de Procesos Padre 
            ...
            If intCombo = 6 Then ' Combo de Tarea Padre
                ddlTareaPadre.Items.Clear()

                dsDataset = clsTareas.ConsultaTareas(Session("IdProceso"), 0, hdnIdRegistro.Value)
            ...
            If intCombo = 7 Then 'Combo tarea Rechazo

                ddlTareaRechazo.Items.Clear()

                dsDataset = clsTareas.ConsultaTareas(0, 0, hdnIdRegistro.Value)
            ...
            If intCombo = 8 Then 'Combo tarea No Rechazo
            ...
            If intCombo = 9 Then 'combo de perfil
            ...
            End If
            'If intCombo = 10 Then 'combo dictamefinal
            '    ddldictamen.Items.Clear()
            '    dsDataset = clsTareas.ObtenerDictame()
            '    ddldictamen.Items.Add(New ListItem("NINGUNO", "0"))
            '    For i = 0 To dsDataset.Tables(0).Rows.Count - 1
            '        ddldictamen.Items.Add(New ListItem(dsDataset.Tables(0).Rows(i).Item(1).ToString, dsDataset.Tables(0).Rows(i).Item(0).ToString))
    ...
    Protected Sub btnRegresar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRegresar.Click
        Response.Redirect("./consultaFlujos.aspx?idProducto=" & Me.ddlProducto.SelectedValue)
    End Sub
