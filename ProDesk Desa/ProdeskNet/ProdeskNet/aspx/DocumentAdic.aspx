<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Home.master" AutoEventWireup="false" CodeFile="DocumentAdic.aspx.vb" Inherits="aspx_DocumentAdic" %>
...
<%--BUG-PD-199: RHERNANDEZ: 24/08/17 SE MODIFICA CARGA DE ARCHIVOS PARA ABRIR VISOR TELEPRO--%>
    ...
    <div class="divPantConsul">
                        ...
                        <table width="100%">
                            <tr>
                                <td colspan="2" style="width: 70%;">
                                    <legend>Documentos Adicionales Agencia. 
                                    </legend>
                                </td>
                            </tr>
                        </table>
                    ...
                    <asp:Repeater ID="repSolicitudes" runat="server">
                        <ItemTemplate>
                            <tr class="GridviewScrollItemBBVA_local">
                                ...
                                <td>
                                    <asp:CheckBox runat="server" ID="chkOption" AutoPostBack="true" OnCheckedChanged="chkSelecciona_CheckedChanged"  CommandArgument='<%# Eval("NumeroSolicitud")%>' />                                                     
        ...
        <div id="divdocumentos" style="height:350px; overflow-y: scroll; " runat="server">
