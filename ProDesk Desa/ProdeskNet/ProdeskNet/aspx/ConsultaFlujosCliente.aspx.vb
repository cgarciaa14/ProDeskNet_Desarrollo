'BBVA: BUG-PD-194: 22/08/2017: CGARCIA: SE CREA PANTALLA DE FLUJO DE CLIENTES
...
Public Class aspx_ConsultaFlujosCliente
    ...
    '    Response.Redirect("./altaFlujos.aspx")
    'End Sub
    ...
    Protected Sub grvConsulta_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grvConsulta.RowCommand
        ...
        If e.CommandName = "catIdFlujos" Then
            Session("Nivel") += 1
            'Response.Redirect("./manejaFlujosCliente.aspx?idFlujo=" & e.CommandArgument)
            Dim path As String = "./manejaFlujosCliente.aspx?idFlujo=" & e.CommandArgument
