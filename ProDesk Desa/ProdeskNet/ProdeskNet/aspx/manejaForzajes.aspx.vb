...
'BUG-PD-41 JBB 27/04/2017 : Se eliminan parametros  que no son utilizados para el redirect dinamico en caso de ser una pantalla que deba mostrarse.  
'BUG-PD-62 ERODRIGUEZ 05/06/2017 : Se agrego paginacion para grid
'BUG-PD-86: AVEGA: 10/06/2017 Se agrega cambio de estatus
'BUG-PD-125: JBEJAR: 29/06/2017 Se agrega validacion en el boton procesar de la ventana modal
...
'BUG-PD-219:JBEJAR:03/10/2017  Mejora log de forzajes. 
...
Partial Class aspx_manejaForzajes
    Inherits System.Web.UI.Page
    Public Pantalla As Integer = 73
    ...
    Public Sub Buscar(IntBandera As Integer)
        ...
        If ValidaCampos() Then
            ...
            ds = objFlujos.ConsultaSolicitud(3)
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows.Count = 1 Then
                        ...
                        If IntBandera = 1 Then
                            DirectCast(gvForzajes.Rows(0).Cells(10).FindControl("chkSelecciona"), CheckBox).Checked = True
    ...
    Protected Sub chkSelecciona_CheckedChanged(sender As Object, e As EventArgs)
        ...
        For i = 0 To gvForzajes.Rows.Count - 1
            _Chk = gvForzajes.Rows(i).Cells(10).FindControl("chkSelecciona")
    ...
    Public Sub Inserta_Forzaje() 'Log de forzajes  
        ...
        objForzaje.Tipo_Forzaje = "Precalificacion " 'Tipo de forzaje
    ...
    Protected Sub redirect()
        ...
        muestrapant = objpantalla.SiguientePantalla(hdSolicitud.Value)
        ...
        If muestrapant = 0 Then
            ' mensaje = dslink.Tables(0).Rows(0).Item("PDK_PANT_LINK").ToString & "?idPantalla=" & dslink.Tables(0).Rows(0).Item("PDK_ID_PANTALLAS").ToString & "&sol=" & hdSolicitud.Value & "&usuario=" & hdusuario.Value
