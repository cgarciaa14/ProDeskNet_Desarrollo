<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/aspx/Home.Master" CodeFile="manejaPerfil.aspx.vb" Inherits="manejaPerfil" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphPantallas" runat="server">
    <div class="divAdminCat">
        <div class="divFiltrosConsul">
            <table>
                 <tr>
                    <td class="tituloConsul">Perfil</td>
                </tr>
            </table>
        </div>
        <div class="divAdminCatCuerpo">
            <div style="position:absolute; top:0%; left:0%; width:40%;">
                <table>
                    ...
                    <tr>
                      <td ><label style="font-size: 8pt;font-family: Arial;color: #666666;">* Nivel:</label></td>
                      <td><asp:TextBox runat="server" Enabled="false"   SkinID="txtNumerosGde" ID="txtNivel"></asp:TextBox>   </td>
            ...
            <table width="100%" style="height:100%;">
                <tr>
                    <td align="center" valign="middle">
                        ...
                        <asp:Button runat="server" id="btnGuardar" text="Guardar" CssClass="buttonBBVA2" Visible="false" />
                    </td>
                </tr>
            </table>
        </div>
