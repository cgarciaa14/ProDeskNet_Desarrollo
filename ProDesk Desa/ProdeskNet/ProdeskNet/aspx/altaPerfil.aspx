...
<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/aspx/Home.Master" CodeFile="altaPerfil.aspx.vb" Inherits="altaPerfil" %>
                ...
                <table>                    
                    ...
                    <tr>
                     <td class="campos">* Nivel:</td>
                      <td><asp:TextBox runat="server" SkinID="txtNumerosGde" Enabled="false" ID="txtNivel"></asp:TextBox>   </td>
                    </tr>
                    <tr>
