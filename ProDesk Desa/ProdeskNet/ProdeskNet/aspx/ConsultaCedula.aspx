<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Home.master" AutoEventWireup="false" CodeFile="ConsultaCedula.aspx.vb" Inherits="aspx_ConsultaCedula" %>
<%@ MasterType VirtualPath="~/aspx/home.master" %>
<%--<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>--%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphPantallas" Runat="Server"> 
<!--BBV-P-423:RQADM-09 05/04/2017 : JBB: Pantalla Consulta cedula. -->
...
<%--BUG-PD-364 GVARGAS 21/02/2018 Correccion panel avoid Ajax Tool Kit--%>
    ...
    <div class="divPantConsul">
                    ...
                    <td width="100%">
                        <table width="100%">
                            <tr>
                                <td>
                                    <legend>
                                        <asp:Label ID="lblNomPantalla" runat="server" Text="Consulta Cédula Profesional"></asp:Label></legend>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <table class="resulbbvarigth">
            <tr>
                <td colspan="5" align="center">Portal Cédula Profesional:&nbsp;&nbsp;&nbsp;<asp:Button ID="btnLinkedin" runat="server" Text="Ir a Cédula Profesional" CssClass="buttonSecBBVA2" OnClick="btnLinkedin_click" /></td>
            </tr>
            <tr>
                <td colspan="5">&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlRedSocial" runat="server" CssClass="selectBBVA" OnSelectedIndexChanged="ddlRedSocial_select_index" AutoPostBack="true" title="¿Existe cédula Profesional?">
