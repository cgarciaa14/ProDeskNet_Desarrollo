...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/aspx/Home.Master" CodeFile="altaRechazos.aspx.vb" Inherits="altaRechazos" %>
        ...
        <div class="divAdminCatCuerpo">
            <div style="position:absolute; top:0%; left:0%; width:70%;">
                <table> 
                    ...
                    <tr>
                       <td class="campos">* Condicionado:</td>
                       <td><asp:DropDownList ID="ddlcondicion" runat="server" Width="195px" SkinID="cmbGeneral"></asp:DropDownList> </td> 
                    </tr>
                    <tr>
