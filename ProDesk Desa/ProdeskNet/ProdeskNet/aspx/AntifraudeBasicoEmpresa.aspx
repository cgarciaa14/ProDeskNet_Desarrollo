<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Home.master" AutoEventWireup="false" CodeFile="AntifraudeBasicoEmpresa.aspx.vb" Inherits="aspx_AntifraudeBasicoEmpresa" %>
        ...
        <div class ="divFiltrosConsul" style="padding-right:5px;" >
            <table class="tabFiltrosConsul">
                ...
                <tr class="tituloConsul">
                    <td colspan="2" style="width:70%;">Antifraude Básico Empresas</td>
