<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Home.master" AutoEventWireup="false" CodeFile="manejaForzajes_Solicitud.aspx.vb" Inherits="aspx_manejaForzajes_Solicitud" %>
...
<%--BUG-PD-22: JBB 2017/03/28 Se agregan los 7 dias anterior a la fecha del sistema--%>
<%--BUG PD-30 CGARCIA 11/04/2017 Se agrego una propiedad runat a la tabla de tbValidaDocumentos--%>
       ...
       <td width="100%">
         <table width="100%">
           <tr>
             <td>
                                    <legend>
                                        <asp:Label ID="lblNomPantalla" runat="server" Text="Forzajes de Solicitud en Admisión"></asp:Label></legend>
             </td>
             <td>
    ...
    <div id="Div1" class="resulbbvaCenter" runat="server">
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtNoSol" CssClass="txt3BBVA" Onkeypress="return ValCarac(event,7);" ></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox runat="server" ID="txtNombre" Width="98%" CssClass="txt3BBVA" MaxLength="50" onkeyup="ReemplazaAcentos(event, this.id, this.value);"></asp:TextBox>
                </td>
                <td>
                ...
                <td>
                    <table>
                        <tr>
                            <td>
                                <asp:TextBox runat="server" ID="txtRFC" CssClass="txt3BBVA" MaxLength="10" ></asp:TextBox>
                            </td>
                        </tr>
                    </table>                    
                </td>
               ...
               <table width="100%" >
                 ...
                 <tr style="width:100%">                   
                   <td align="center" valign="middle" style="width:50%">
                        <input type="button" runat="server" id="btnAdelantarCliente" value="Procesar" onclick="btnAdelantarCliente_click();" ondblclick="disabled=true"/>                         <%--BUG-PD-125 doble click deshabilitado--%>
                   </td>
                     <td align="center" valign="middle" style="width:50%">
