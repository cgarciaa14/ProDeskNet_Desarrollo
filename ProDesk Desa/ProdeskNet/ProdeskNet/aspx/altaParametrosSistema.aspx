<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/aspx/Home.Master" CodeFile="altaParametrosSistema.aspx.vb" Inherits="altaParametrosSistema" %>
            ...
            <div style="position:absolute; top:0%; left:0%; width:70%;">
                <table>                    
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" SkinID="txtNumeros" id="txtValorFecha"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td ><label style="font-size: 8pt;font-family: Arial;color: #666666;">Valor Numero:</label></td>
                        <td>
                            <asp:TextBox runat="server" SkinID="txtNumeros" id="txtValorNumero"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
