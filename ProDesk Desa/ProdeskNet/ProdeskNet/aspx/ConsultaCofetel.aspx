<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Home.master" AutoEventWireup="false" CodeFile="ConsultaCofetel.aspx.vb" Inherits="aspx_ConsultaCedula" %>

<%@ MasterType VirtualPath="~/aspx/home.master" %>
<%--<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>--%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphPantallas" runat="Server">
    <!--BBV-P-423:RQADM-10 JBEJAR 19/04/2017: Pantalla Consulta cofetel. -->
    <!--BUG-PD-44:JBEJAR:10/05/2017:CORRECION EN VALIDACIONES.-->
    ...
    <script type="text/javascript">
        ...
        function btnProcesarCliente_Enable() {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_cmbguardar1C').hide(true);
        }
        ...
        function Replica() {
            ...
            var Select = $("#ctl00_ctl00_cphCuerpo_cphPantallas_ddlRedSocial").val()
            var Select1 = $("#ctl00_ctl00_cphCuerpo_cphPantallas_ddlExitelm").val()
            var Select2 = $("#ctl00_ctl00_cphCuerpo_cphPantallas_ddlexitem").val()
            var Select3 = $("#ctl00_ctl00_cphCuerpo_cphPantallas_ddltelref1").val()
            var Select4 = $("#ctl00_ctl00_cphCuerpo_cphPantallas_ddltelref2").val()

            if (Select == -1) {

                alert('Debes seleccionar un valor para ¿Existe teléfono fijo del solicitante?');
    ...
    <div class="divPantConsul">
                    ...
                    <td width="100%">
                        <table width="100%">
                            <tr>
                                <td>
                                    <legend>
                                        <asp:Label ID="lblNomPantalla" runat="server" Text="Consulta Cofetel"></asp:Label></legend>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <table class="resulbbvarigth">
            <tr>
                <td colspan="3" align="center">Portal Quién Habla:&nbsp;&nbsp;&nbsp;<asp:Button ID="btnQuien" runat="server" Text="Ir a Portal Quién Habla" CssClass="buttonSecBBVA2" OnClick="btnQuien_click" /></td>
                <td align="center">Portal COFETEL:&nbsp;&nbsp;&nbsp;<asp:Button ID="btnCofetel" runat="server" Text="Ir a Portal COFETEL" CssClass="buttonSecBBVA2" OnClick="btnCofetel_click" /></td>
            </tr>
            <tr>
                <td colspan="5">&nbsp;</td>
            </tr>
            ...
            <tr>
                <td>¿Existe teléfono fijo del solicitante? * </td>
                <td>
                    <asp:DropDownList ID="ddlRedSocial" runat="server" CssClass="selectBBVA" OnSelectedIndexChanged="ddlRedSocial_select_index" AutoPostBack="true" title="¿Existe teléfono fijo del solicitante?" required>
                ...
                <td>&nbsp;</td>
                <td>¿Es un teléfono fijo o móvil?</td>
                <td>
                    <asp:DropDownList ID="ddlGeoloca" runat="server" CssClass="selectBBVA" title="¿Es un teléfono fijo o móvil?">
                        <asp:ListItem Value="-1" Text="<SELECCIONAR>" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Fijo"></asp:ListItem>
                        <asp:ListItem Value="0" Text="Móvil"></asp:ListItem>
                    </asp:DropDownList></td>

            </tr>
            <tr>
                <td>Compañía a la que pertenece</td>
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="txtBBVA" MaxLength="30" title="Compañia" Onkeypress="return ValCarac(event, 25);" /></td>
                <td>&nbsp;</td>
                <td>¿Existe teléfono móvil?</td>
                <td>
                    <asp:DropDownList ID="ddlExitelm" runat="server" CssClass="selectBBVA" OnSelectedIndexChanged="ddlExitelm_select_index" AutoPostBack="true" title="¿Existe teléfono móvil?">
                        <asp:ListItem Value="-1" Text="<SELECCIONAR>" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Si"></asp:ListItem>
                        <asp:ListItem Value="0" Text="No"></asp:ListItem>
                        <asp:ListItem Value="2" Text="Página no disponible"></asp:ListItem>
            ...
            <tr>
                <td>¿Es un teléfono fijo o móvil? </td>
                <td>
                    <asp:DropDownList ID="ddlTelfm" runat="server" CssClass="selectBBVA" title="¿Es un teléfono fijo o móvil?">
                        <asp:ListItem Value="-1" Text="<SELECCIONAR>" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Fijo"></asp:ListItem>
                        <asp:ListItem Value="0" Text="Móvil"></asp:ListItem>
                    </asp:DropDownList></td>
                ...
                <td>Compañía a la que pertenece</td>
                <td>
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="txtBBVA" MaxLength="30" title="Compañia" OnKeypress="return ValCarac(event, 25);" /></td>

            </tr>

            <tr>
                <td>¿Existe teléfono de empresa? </td>
                <td>
                    <asp:DropDownList ID="ddlexitem" runat="server" CssClass="selectBBVA" title="¿Existe teléfono de empresa?">
                        <asp:ListItem Value="-1" Text="<SELECCIONAR>" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Existe"></asp:ListItem>
                        <asp:ListItem Value="0" Text="No existe"></asp:ListItem>
                        <asp:ListItem Value="2" Text="Página no disponible"></asp:ListItem>
                    </asp:DropDownList></td>
                <td>&nbsp;</td>
                <td>¿Existe teléfono de referencia 1?</td>
                <td>
                    <asp:DropDownList ID="ddltelref1" runat="server" CssClass="selectBBVA" title="¿Existe teléfono de referencia 1?">
                        <asp:ListItem Value="-1" Text="<SELECCIONAR>" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Existe"></asp:ListItem>
                        <asp:ListItem Value="0" Text="No existe"></asp:ListItem>
                        <asp:ListItem Value="2" Text="Página no disponible"></asp:ListItem>
            ...
            <tr>
                <td>¿Existe teléfono de referencia 2? </td>
                <td>
                    <asp:DropDownList ID="ddltelref2" runat="server" CssClass="selectBBVA" title="¿Existe teléfono de referencia 2?">
                        <asp:ListItem Value="-1" Text="<SELECCIONAR>" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Existe"></asp:ListItem>
                        <asp:ListItem Value="0" Text="No existe"></asp:ListItem>
                        <asp:ListItem Value="2" Text="Página no disponible"></asp:ListItem>
    ...
    <div id="divcancela" class="cajadialogo" style="display: none; z-index: 1010 !important; position: absolute; background-color: white; top:15%; left:31%; width: 220px;">
        ...
        <%--<asp:Panel ID="popCancela" runat="server" CssClass="cajadialogo ">
            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="2">
                        <textarea id="TxtmotivoCan" runat="server" onkeypress="return ValCarac(this.event, 6);" class="Text" rows="5" cols="1" style="width: 95%"></textarea>
                    </td>
                </tr>
                <tr style="width: 100%">
                    <td>
