...
function jsonBack(errorLabel, destino, successfully, datos) {
    ...
    settings.failure = function(response) {
        alert("Error al cargar : " + errorLabel.toString());
    }
    $.ajax(settings);
}
...
function OnSuccessNextTarea(response) {
    if (response.d.indexOf("Tarea Exitosa.") >= 0) {
        ...
        if (mostrar != "0") {
            url = "consultaPanelControl.aspx";
        } else {
            var usu = $("[id*='hdidUsuario']").val();
            var sol = $.urlParam("idFolio").toString();
            url = url + "?idPantalla=" + id_pantalla + "&sol=" + sol + "&Enable=0&usu=" + usu;
        }
...
function OnSuccessTP(response) {
    ...
    $('[type="text"][id*="FECHA_NACIMIENTO"]').val(fech[0] + "/" + fech[1] + "/" + fech[2]).prop("disabled", true);
    $('[type="text"][id*="TIPO_PERSONA"]').val(returnVars[1]).prop("disabled", true);
}
...
function OnSuccessDU(response) {
    if (response.d.toString() == "1") {
        $('select[id*="DESTINO_UNIDAD"]').val(1474).prop("disabled", true);
    } else if (response.d.toString() == "0") {
        $('select[id*="DESTINO_UNIDAD"]').val(1473).prop("disabled", true);
    }
}
...
function OnSuccessHA(response) {
    ...
    if ((HAArray[0]) != "3") {
        $('[ID*="PDK_TAB_CONDUCTOR_RECURRENTE"]').fadeOut();
    } else {
        if (HAArray[1] == "1") {
            $('[type="checkbox"][id*="CONDUCTOR_RECURRENTE"]').prop("checked", true);
        } else {
            $('[type="checkbox"][id*="CONDUCTOR_RECURRENTE"]').prop("checked", false);
        }
    }
}
...
function OnSuccessCI(response) {
    if (response.d.toString() == "CI") {
        $('select[id*="TIPO_CREDITO"]').val(1479).prop("disabled", true);
    } else if (response.d.toString() == "TRADICIONAL") {
        $('select[id*="TIPO_CREDITO"]').val(1478).prop("disabled", true);
        $('[id*="PDK_TAB_FIEL"]').hide();
    }
}
...
function OnSuccessCities(response) {
    ...
    $.each(items, function(i, item) {
        $('[id*="PDK_TAB_LUGAR_NACIMIENTO"] select[id*="CIUDAD"]').append($('<option>', {
            value: item.id,
            text: item.c
        }));
    });
...
function OnSuccessCI_(response) {
    ...
    if (count_ == 3) {
        ...
        if (items[2].toString() == "1") {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtAUTORIZO_INE591").prop("checked", true);
        } else {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtAUTORIZO_INE591").prop("checked", false);
        }
    } else {
...
$(document).ready(function() {
    ...
    $("select").on("change", function() {
        ...
        if (SelectedValor == 1510) {
            $('[id*="PDK_TAB_LUGAR_NACIMIENTO"] select[id*="CIUDAD"]').find('option').remove().end();
        }
        if (SelectedValor == 1545) {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_ddltxtPAIS_DOMICILIO550').find('option').remove().end();
        }
        ...
        if (((SelectedValor > 1490) && (SelectedValor < 1495)) || (SelectedValor == 11) || ((SelectedValor > 1798) && (SelectedValor < 1821))) {
            ...
            if (SelectedValor == 1493) {
                ...
                $("#ctl00_ctl00_cphCuerpo_cphPantallas_lbl543\\|CLAVE_ELECTOR div span").html("Clave de Elector <span class='tooltiptext'><img src='../App_Themes/Imagenes/ine.png'></span>");
                if (SelectedValor == 1491) {
                    $("#img_dinamic").attr("src", "../App_Themes/Imagenes/cp.png");
                } else if (SelectedValor == 1492) {
                    $("#img_dinamic").attr("src", "../App_Themes/Imagenes/passport.png");
                } else if (SelectedValor == 1494) {
                    $("#img_dinamic").attr("src", "../App_Themes/Imagenes/fm.png");
                }
            }
        }
        ...
        if (SelectedValor == 1654) {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_ddltxtREGIMEN_CONYUGAL535').val('').prop("disabled", true);
        } //Arregla regimen conyugal

        if ((SelectedValor > 1620) && (SelectedValor < 1634)) {
            if (SelectedValor == 1633) {
    ...
    $('input').focusout(function(e) {
        ...
        if (($.urlParam("idPantalla").toString() == '7') || (id_select == 'ctl00_ctl00_cphCuerpo_cphPantallas_txtRFC8')) {
            ...
            if ((id_select == 'ctl00_ctl00_cphCuerpo_cphPantallas_txtMESES_RESIDE_DOM534') || (id_select == 'ctl00_ctl00_cphCuerpo_cphPantallas_txtANOS_RESIDE_DOM29')) {
                if ($("#ctl00_ctl00_cphCuerpo_cphPantallas_txtMESES_RESIDE_DOM534").val() == "") {
                    return;
                }
                if ($("#ctl00_ctl00_cphCuerpo_cphPantallas_txtANOS_RESIDE_DOM29").val() == "") {
                    return;
                }
                ...
                if (anios == "0") {
                    ...
                    if (meses < 6) {
                        ...
                        setTimeout(function() {
                            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtANOS_RESIDE_DOM29").val("").focus();
                        }, 1);
                    }
                }
            }
            ...
            if ((id_select == 'ctl00_ctl00_cphCuerpo_cphPantallas_txtANOS_ANTIGUEDAD42') || (id_select == 'ctl00_ctl00_cphCuerpo_cphPantallas_txtMESES_ANTIGUEDAD553')) {
                ...
                if (((anios == 0) && (meses < 3)) || (anios > 0)) {
                    ...
                    if ((anios == 0) && (meses < 3)) {
                        ...
                        setTimeout(function() {
                            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtMESES_ANTIGUEDAD553").val("").focus();
                        }, 1);
                    }
                    return;
                }
                    ...
                    if (!RFC.match(/^([A-ZÑ\x26]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))((-)?([A-Z\d]{3}))?$/)) {
                        ...
                        if (countRFC == "0") {
                            ...
                            if (countRFC != RFC) {
                                ...
                                countRFC = "0";
                                $("#" + id_select).val($("#" + id_select).val().toUpperCase());
                            } //BUG_PD_08
                        }
    ...
    if (Enable = "0") {
        if (($.urlParam("idPantalla").toString()) == "7") {
            ...
            if (img_dinamic != 1493) {
                ...
                if (img_dinamic == 1491) {
                    $("#img_dinamic").attr("src", "../App_Themes/Imagenes/cp.png");
                } else if (img_dinamic == 1492) {
                    $("#img_dinamic").attr("src", "../App_Themes/Imagenes/passport.png");
                } else if (img_dinamic == 1494) {
                    $("#img_dinamic").attr("src", "../App_Themes/Imagenes/fm.png");
                }
            } else {
                $("#img_dinamic").attr("src", "../App_Themes/Imagenes/n_iden.png");
    ...
    $('[name$=txtPREGUNTA1422]').click(function() {
        ...
        if ($(this).parent().text() == "SI") {
            ...
            $('[id$=hdvalidad]').val('NUMERO_CREDITO153')
        } else {
    ...
    $('[name$=txtPREGUNTA1425]').click(function() {
        ...
        if ($(this).parent().text() == "SI") {
            enable.removeAttr('disabled');
            $('[id$=hdvalidadCoa]').val('NUMERO_DE_CREDITO_COA176');
        } else {
            enable.attr('disabled', 'disabled');
            $('[id$=hdvalidadCoa]').val('');
        }
    ...
    if (pantalla == 1 || pantalla == 7 || pantalla == 23 || pantalla == 29 || pantalla == 35 || pantalla == 41 /*|| pantalla == 59*/ ) {
        ...
        if (anos != "") {
            $('[id$=ddltxtANO_NACIMIENTO412]')[0].value = anos;
        }
        if (mes != "") {
            if (mes < 10) {
                mes = '0' + mes;
            }
            $('[id$=ddltxtMES_NACIMIENTO413]')[0].value = mes;
        }
        if (dia != "") {
            if (dia < 10) {
                dia = '0' + dia;
            }
            $('[id$=ddltxtDIA_NACIMIENTO414]')[0].value = dia;
        }
        ...
        if (anos != "") {
            $('[id$=ddltxtANO_NACIMIENTO415]')[0].value = anos;
        }
        if (mes != "") {
            if (mes < 10) {
                mes = '0' + mes;
            }
            $('[id$=ddltxtMES_NACIMIENTO416]')[0].value = mes;
        }
        if (dia != "") {
            if (dia < 10) {
                dia = '0' + dia;
            }
            $('[id$=ddltxtDIA_NACIMIENTO417]')[0].value = dia;
        }
        ...
        if (anoscoa != "") {
            $('[id$=ddltxtANO_NACIMIENTO415]')[0].value = anoscoa;
        }
        if (mescoa != "") {
            if (mescoa < 10) {
                mescoa = '0' + mescoa;
            }
            $('[id$=ddltxtMES_NACIMIENTO416]')[0].value = mescoa;
        }
        if (diacoa != "") {
            if (diacoa < 10) {
                diacoa = '0' + diacoa;
            }
            $('[id$=ddltxtDIA_NACIMIENTO417]')[0].value = diacoa;
        }
    ...
    if (pantalla == "7") {
        //BUG PD 34
        if ($('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO163').val() == "0") {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO163').val('');
        }
        if ($('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO562').val() == "0") {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO562').val('');
        }
        if ($('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO565').val() == "0") {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO565').val('');
        }
        ...
        if ($("#ctl00_ctl00_cphCuerpo_cphPantallas_ddltxtCOMPANY_TEL_PARTICULAR582").val() == 1667) {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_ddltxtCOMPANY_TEL_PARTICULAR582").val(1668);
        }
        //BUD PD 10
        ...
        if ($('#ctl00_ctl00_cphCuerpo_cphPantallas_txtCURP19').val() == "AAAA999999AAAAAA99") {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtCURP19').val('');
        }

        if ($("#ctl00_ctl00_cphCuerpo_cphPantallas_txtHOMOCLAVE443").val() == "999") {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtHOMOCLAVE443").val("");
        }

        if ($("#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO_MOVIL10__").val() == "9999999999") {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO_MOVIL10").val("");
        } //Arregla validar Celular
        ...
        if ($("#ctl00_ctl00_cphCuerpo_cphPantallas_txtNUM_DEPENDIENTES536").val() == 'NOFX') {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtNUM_DEPENDIENTES536").val('')
        }

        if ($("#ctl00_ctl00_cphCuerpo_cphPantallas_txtINGRESOS_VARIABLES540").val() == '0') {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtINGRESOS_VARIABLES540").val('')
        }
    ...
    if ($("#ctl00_ctl00_cphCuerpo_cphPantallas_ddltxtTIPO_IDENTIFICACION541").val() == 1493) {} else {
        $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtCLAVE_ELECTOR543').val("").prop("disabled", true);
    }
    ...
    if (pantalla == "1") { //BUG PD 03 habilita en pantalla 1 RFC y HOMOCLAVE
        if ($('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO_MOVIL10').val() == "0") {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO_MOVIL10').val('');
        }
        if ($('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO_PARTI9').val() == "0") {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtTELEFONO_PARTI9').val('');
        }
        if ($('#ctl00_ctl00_cphCuerpo_cphPantallas_txtNUM_COTIZACION441').val() == "0") {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtNUM_COTIZACION441').val('');
        }
        if ($('#ctl00_ctl00_cphCuerpo_cphPantallas_txtCP14').val() == "0") {
            $('#ctl00_ctl00_cphCuerpo_cphPantallas_txtCP14').val('');
        }
    ...
    $('input').on("change paste keyup dragend", function() {
        if (($.urlParam("idPantalla").toString() == '1') && ($(this).attr('id').toString() != "ctl00_ctl00_cphCuerpo_cphPantallas_txtNUM_COTIZACION441")) {
            ...
            $(this).val($(this).val().toString().replace(/[^\w ]/g, function(char) {
        ...
        if (tam == 1) {
            ...
            if ((ultimo == " ") && (penultimo == " ")) {
                $("#" + $(this).attr('id').toString()).val(newTEXT.toString());
            }
        }
    });
});
...
function llenado(id) {
    ...
    if (verifiTel.length < 5) {
        ...
        setTimeout(function() {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtCP14").val("").focus();
        }, 1);
        return;
    }
...
function llenadoEmp(id) {
    ...
    if (verifiTel.length < 5) {
        ...
        setTimeout(function() {
            $("#ctl00_ctl00_cphCuerpo_cphPantallas_txtCP50").val("").focus();
        }, 1);
        return;
    }
    ...
    if (($.urlParam("idPantalla").toString() == "7") && (id != 'ctl00_ctl00_cphCuerpo_cphPantallas_btnGuardarCancelar')) {
        ...
        if (msg.length > 14) {
            ...
            $.each(msgs, function(i, m) {
                listaMsg = msgs[i].toString().split(',').join('\n');
            });
        ...
        if ((telefono1.length < 10) || (telefono2.length < 10) || (telefono3.length < 10) || (telefono4.length < 10) || (telefono5.length < 10)) {
            ...
            if (telefono1.length < 10) {
                mensajetel = mensajetel + "El Teléfono Móvil\n";
            }
            if (telefono2.length < 10) {
                mensajetel = mensajetel + "El Teléfono en la sección Datos de Empleo\n";
            }
            if (telefono3.length < 10) {
                mensajetel = mensajetel + "El Teléfono (Conocido)\n";
            }
            if (telefono4.length < 10) {
                mensajetel = mensajetel + "El Teléfono (Familiar)\n";
            }
            if (telefono5.length < 10) {
                mensajetel = mensajetel + "El Teléfono (Arrendador)\n";
            }
        ...
        if (validCREDITO != '') {
            mensaje = validCREDITO
        }
        if (validadrenta != '') {
            mensaje += validadrenta
        }
        if (validadRenta2 != '') {
            mensaje += validadRenta2
        }
        if (validaCrediCoa != '') {
            mensaje += validaCrediCoa
        }
        ...
        mater.each(function(index) {
            ...
            $(this).children("caption").each(function(index2) {
                tablas += $(this).text()
            }) //traer el nombre de la tabla 
            ...
            newtb.each(function(index) {
                ...
                $(this).children("td").each(function(index3) {
                    ...
                    $(this).children("textarea").each(function(index7) {
                        ...
                        var texto = $(this).val();
                        if ((cvepantalla != 4) && (cvepantalla != 1)) {
                            if (texto == '' || texto == 0) {
                                mensaje += $(this)[0].name;
                            }
                        }
        ...
        if (botones == "btnGuardarAutoriza") {
            ...
            $('#ventanaContain').hide();
            if (txtUsu == '') {
                alert('El campo usuario esta vacía');
                return;
            }
            if (txtpsswor == '') {
                alert('El campo del password esta vacía');
                return;
            }
            if (txtmotivoOb == '') {
                alert('El campo de motivo esta vacía');
                return;
            }
            ...
            if (mensaje1.length > 0) {
                alert('Debes de selecionar el campo ' + mensaje1);
            ...
            if ((mensaje != "CLAVE_ELECTOR543") || (mensaje.indexOf("589") >= 0) || (mensaje.indexOf("591") >= 0)) {
                if (mensaje.length > 0) {
                    alert('Los campos estan vacios ' + mensaje.replace("CLAVE_ELECTOR543"));
                    $('#ctl00_ctl00_cphCuerpo_cphPantallas_Button1').removeAttr('disabled', '');
                    return;
                }
            }
            var camposTelefono = [];
            $('[id*="txtTELEFONO"]').each(function(index, value) {
                var idSplit = $(value).attr('id').split('txt');
                camposTelefono.push(idSplit[1])
            });
            ...
            //console.log(strPantalla);

            //if ((strPantalla == 'PRECALIFICACION') || (strPantalla == 'COACREDITADO')) {
            //    console.log(cadena + ' ' + cadenaUp + ' ' + queryExtra + ' ', pantalla, '' + f + '', '1', '' + u + '');
            //} else {
            //    console.log(cadena + ' ' + cadenaUp + ' ' + '  EXEC spValNegocio ' + f + ',64,' + u, pantalla, '' + f + '', '1', '' + u + '');
            //}
        }

        //console.log(cadena);
        //console.log(cadenaUp);
        //console.log(botones);

        $('[id*=Button1].buttonBBVA2').prop('disabled', false);
        return false;
    }
} //POR VERSE
...
function btnGuardarTMP() {
    if (($.urlParam("idPantalla").toString()) == "7") {
        var ciudad = $("#ctl00_ctl00_cphCuerpo_cphPantallas_ddltxtCIUDAD547 option:selected").text();
        if (ciudad.toString() == "< SELECCIONAR >") {
            $('[id*="PDK_TAB_LUGAR_NACIMIENTO"] select[id*="CIUDAD"]').html('');
